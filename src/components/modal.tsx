    ...
    return (
        <div className={modalClassName}>
            <div className="modal-content">
                ...
                <textarea name="modal-input" id="modal-input" rows={4} className="modal-input" value={modalInput} onChange={(e) => setModalInput(e.target.value)} placeholder={"Type here..."} autoFocus></textarea>
